...
export const ViewAgentPolicyAccount = () => {
  ...
  return (
    <div className='content-area'>
      {loading && <Loader />}
      <AreaTop pageTitle={`View Policy Account ${formState.policyAccountId}`} pagePath={"View-Policy-Account"} pageLink={`/agent/accounts${localStorage.getItem('id')}`} />
