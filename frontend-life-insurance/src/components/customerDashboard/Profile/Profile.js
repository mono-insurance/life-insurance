                ...
                <div className="fixed z-50 inset-0 flex items-center justify-center">
                    <div className="bg-white p-6 rounded-lg shadow-lg relative">
                        <button 
                            ...
                            onClick={closeModal} // Ensure this is correctly wired
                        >
                            &times; {/* Use × for better visibility */}
                        </button>
                        <img 
                    ...
                    <div className="fixed inset-0 bg-black opacity-50" onClick={closeModal}></div> {/* Close modal when clicking the background */}
                </div>
            )}
        </div>
        </div>
