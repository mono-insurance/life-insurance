...
export const AllTransactions = () => {
    ...
    return (
        <div className='content-area'>
            <AreaTop pageTitle={"All Transactions"} pagePath={"customer-transactions"} pageLink={`/admin/dashboard/${routeParams.id}`} />
            ...
            {(showActiveCustomers || showInactiveCustomers) && (
                <section className="content-area-table">
                    <div className="data-table-info">
                        <h3 className="data-table-title">Get All Transactions</h3>
                    </div>
