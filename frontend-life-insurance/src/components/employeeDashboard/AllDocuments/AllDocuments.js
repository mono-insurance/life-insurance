...
export const AllDocuments = () => {
    ...
    const customerTable = async () => {
        try {
            ...
            if (filterType === 'active') {
                ...
                response = await getDocumentById(id);
            }
            else {
            ...
            setData(response);
            setKeysToBeIncluded(["documentId", "documentType", "isApproved"]);
    ...
    const handleActivateCustomer = async (e) => {
        ...
        await approveDocument(customerId, true)
        customerTable()
    }
            ...
            <div className='content-area-customers'>
                ...
                <section className="content-area-table-customers">
                    ...
                    <div className="admin-form">
                        <div className='activate-form' hidden={filterType == '' || filterType == 'active'}>
                            <form>
                                {
                                    filterType == 'inactive' &&
